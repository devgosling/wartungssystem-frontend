<template>
  ...
  >
    ...
    <div class="createcustomerdialog-inputgroup">
      ...
      <InputText v-model="dialogValues.street" id="street" placeholder="Am Werrtor 12a"></InputText>
    </div>
    <div class="createcustomerdialog-inputgroup">
    ...
    <div class="createcustomerdialog-inputgroup">
      ...
      <InputText v-model="dialogValues.city" id="city" disabled placeholder="Biblis"></InputText>
    </div>
    <div class="createcustomerdialog-inputgroup">
      <label for="email">E-Mail Adresse</label>
      <InputText :invalid="invalidEmail" v-model="dialogValues.email" id="email"></InputText>
    </div>
